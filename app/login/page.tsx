...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // If an explicit callbackUrl was provided (e.g. user was sent to login from a protected page), honor it.
    // Otherwise, inspect the authenticated user's role and send admins to the admin dashboard.
    if (callbackParam) {
    ...
    // No callback specified — determine destination based on role
    try {
      ...
      // Fallback to the standard dashboard on any error
